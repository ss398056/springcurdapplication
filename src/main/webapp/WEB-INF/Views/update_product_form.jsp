...
<div class="container form-container">
    ...
    <form action="updateproductprocess" method="post" enctype="multipart/form-data">
    	<input type="hidden" class="form-control" id="productName" name="id" value="${product.id }">
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-custom w-100" name="submit">Update Product</button>
    </form>
